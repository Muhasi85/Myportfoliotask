...
<body>
	<!--Header(start)-->
	<table id="header" border="0"<!DOCTYPE html>
		...
		<tr>
			<td>
				<table border="0" cellpadding="15"
					...
					<tr>
						<td width="40%">
							<img src="C:\Users\kisho\Downloads\R.jpeg" alt="me"
						...
						<td width="60%">
							<font face="Verdana" size="4"
								color="black">
						          Here is a short story about me as a personal portfolio
								website.
								<hr color="black">
								I'm Muhasina graduated in Bachelor of Engineering in Computer Science engineering.After completing my under graduation I am currently doing my Master's in web development domain
            ...
            <td>
                <table border="0" cellpadding="15"
                    ...
                    <tr>
                        ...
                        <td width="45%">
                            <img src="C:\Users\kisho\Downloads\200303_Blog_Feature_MSP.jpg"
                                 alt="Project" width="450" height="450">
                        </td>
                    </tr>
                </table>
            </td>
							...
							<font face="Verdana" size="4" color="white">
								<ul>
									...
									<li>
										...
										<hr color="black">
										<hr color="black">
										<b>Mentored HacKathon.</b>
										<ul>
											<li>
												May,2022.
											</li>
											<li>
												Selected from KWC as Student
